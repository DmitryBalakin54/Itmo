...
public class B5 {
    ...
    public static void mainProgram() throws IOException {
       // MyScanner scan = new MyScanner(System.in);
        ...
        //System.err.println(dp[n - 1][m - 2]);
        //System.err.println(field[n - 1][m - 2]);
        while (indexX != 0 || indexY != 0) {
            if (indexX == 0) {
                ...
                //System.err.println(dp[indexY - 1][indexX] + " " + dp[indexY][indexX - 1]);
                if (dp[indexY - 1][indexX] > dp[indexY][indexX - 1]) {
                    str.append('D');
                    indexY--;
                } else {
                    str.append('R');
