...
public final class RunMe {
    ...
    private static void key4(final byte[] password) {
        for (long i =8329482348347087432L^ (8329482348347087432L>>>32)/*Long.MIN_VALUE*/; i < Long.MAX_VALUE; i++) {
    ...
    private static void key5(final byte[] password) {
        ...
        long result = 0;
		long del2 , del3 , del4 , del2022;
		
	//	del2 = n % 2 = 0 ? (n/2)*(n/2+1)-n/2 : (n/2)*(n/2+1);
		//del3 = 
