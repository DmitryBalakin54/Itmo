...
import ru.itmo.wp.web.page.EnterPage;
...
public class FrontServlet extends HttpServlet {
    ...
    private void process(Route route,
        ...
        Method beforeMethod = getMethod(route, pageClass, Route.getBeforeAction());
        Method afterMethod = getMethod(route, pageClass, Route.getAfterAction());
...
//        putUser(request, view);
    ...
    private static Method getMethod(Route route, Class<?> pageClass, String methodName) throws NotFoundException {
        Method method = null;
...
//    }
    ...
    private static final class Route {
        ...
        private static String getBeforeAction() {
            return BEFORE_ACTION;
        }

        private static String getAfterAction() {
            return AFTER_ACTION;
        }
