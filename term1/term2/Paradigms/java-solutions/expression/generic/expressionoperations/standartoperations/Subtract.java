...
public class Subtract<T> extends Operation<T> implements MultiExpression<T> {

    public Subtract(MultiExpression<T> leftOperand, MultiExpression<T> rightOperand, GenericOperations<T> operation) {
